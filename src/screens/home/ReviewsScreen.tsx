      ...
      <Card style={{ padding: spacing.md, marginBottom: spacing.md }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: spacing.sm, marginBottom: spacing.sm }}>
          ...
          <View>
            ...
            <Text style={{ fontSize: 12, color: colors.textTertiary }}>In-app reviews from verified AutoMate bookings</Text>
          </View>
        </View>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: spacing.md }}>
          <View style={{ alignItems: 'center' }}>
            <Text style={{ fontSize: 24, fontWeight: '800', color: colors.textPrimary }}>{shop.ratingAvg}</Text>
            <Text style={{ color: '#F5B84E', fontSize: 13 }}>★★★★★</Text>
            <Text style={{ fontSize: 12, color: colors.textTertiary }}>{shop.ratingCount} reviews</Text>
          </View>
          <View style={{ flex: 1, gap: 3 }}>
            {bars.map(([n, w]) => (
              <View key={n} style={{ flexDirection: 'row', alignItems: 'center', gap: 5 }}>
                <Text style={{ fontSize: 12, color: colors.textTertiary, width: 10 }}>{n}</Text>
