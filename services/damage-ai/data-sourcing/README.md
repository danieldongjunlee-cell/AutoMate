...
1. Read SOURCES.md, download Tier-1 datasets (Kaggle + Roboflow, ~4K labeled imgs)
      → export/download as "YOLOv8 segmentation" where offered
2. python remap_classes.py  --src <download> --map <see SOURCES.md> --out ../data/raw/<name>
      → converts each dataset's classes to ours (0:dent 1:scratch 2:crack 3:paint)
